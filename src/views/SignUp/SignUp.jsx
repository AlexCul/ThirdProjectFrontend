...
mutation($email: String, $fullName: String!, $password: String!, $nickname: String!) {
    createUser(email: $email, fullName: $fullName, password: $password, nickname: $nickname) {
        status
        token
    }
}
...
export default function SignUp() {
    ...
    return (
        <form className={styles.signup} onSubmit={handleSubmit((user) => {
