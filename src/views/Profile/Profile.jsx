...
export default function Profile() {
  ...
  if (errorId || errorProfile || errorJwt)
    return (
      <p>
        Error: {errorId?.message || errorProfile?.message || errorJwt?.message}
      </p>
    );
        ...
        <div className={styles.user}>
          ...
          <div className={styles.info}>
            ...
            <div className={styles.counts}>
              <p>
                <b>{dataProfile.user.posts.length}</b> posts
              </p>
              <p>
                <b>{dataProfile.user.followers.length}</b> followers
              </p>
              <p>
                <b>{dataProfile.user.following.length}</b> following
              </p>
            </div>
