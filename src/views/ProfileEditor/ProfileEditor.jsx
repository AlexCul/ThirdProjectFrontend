...
export default function ProfileEditor() {
  ...
  if (!dataByToken || nick !== dataByToken.userByToken.nickname)
    return <p>Not your profile</p>;
    ...
    <>
      <div className="content">
        ...
        <form className={styles.editor} onSubmit={handleSubmit(onSave)}>
          ...
          <div className={styles.avatar}>
            <div className={styles.info}>
              ...
              <div className={styles.text}>
                <h5>{nick}</h5>
                <p>
                  {dataByToken.userByToken.description || "No description..."}
                </p>
              </div>
            </div>
            <input
          ...
          {errorUpdate && (
            <p className={styles.error}>Error: {errorUpdate.message}</p>
          )}
        </form>
      </div>
      <Footer />
